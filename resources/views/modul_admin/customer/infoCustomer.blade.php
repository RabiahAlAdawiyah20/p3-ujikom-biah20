...
@section('title', 'Admin - Detail Data Pelanggan')
@section('header', 'Detail Data Pelanggan')
@section('content')
    <div class="row">
                    ...
                    <div class="row">
                        <div class="card-body">
                            <div class="card-text">
                                ...
                                <dl class="row">
                                    <dt class="col-sm-4">Email Pelanggan</dt>
                                ...
                                <dl class="row">
                                    <dt class="col-sm-4">Alamat Pelanggan</dt>
        ...
        <div class="col-sm-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Detail Transaksi Pelanggan</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">

                        ...
                        <div class="row p-t-20">
                            <div class="col-md-4">
                                <div class="form-group has-success">
                                    ...
                                    <input type="text"
                                        ...
                                        name="name" value="{{ old('name') }}" placeholder="Nama Customer"
                                        autocomplete="off">
                                    @error('name')
                            ...
                            <div class="col-md-4">
                                <div class="form-group has-success">
                                    ...
                                    <input type="number"
                                        class="form-control form-control-danger @error('no_telp') is-invalid @enderror"
                                        name="no_telp" placeholder="Nomor WhatsApp" value="{{ old('no_telp') }}"
                                        autocomplete="off">
                                    @error('no_telp')
                                        <span class="invalid-feedback text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-8">
                                <div class="form-group has-success">
                                    ...
                                    <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3"
                                        placeholder="Alamat Customer"> {{ old('alamat') }} </textarea>
                                    @error('alamat')
                                        <span class="invalid-feedback text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>

...
@section('title', 'Admin - Data Harga Paket Laundry')
@section('content')
    ...
    @if ($getBank > 0)
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"> Data Harga Paket Laundry Per-Cabang
            ...
            <div class="col-lg-4">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-black">Form Tambah Data Harga Paket</h4>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group has-success">
                                                ...
                                                <input type="text" name="jenis" value="{{ old('jenis') }}"
                                                    ...
                                                    placeholder="Tambahkan Jenis Pakaian" autocomplete="off">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group has-success">
                                                ...
                                                <input type="text" class="form-control form-control-danger"
                                                    value="1 Kg" placeholder="Berat" readonly autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">

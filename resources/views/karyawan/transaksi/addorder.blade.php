                                        ...
                                        <select name="customer_id" id="customer_id"
                                            ...
                                            @foreach ($customer as $customers)
                                                <option value="{{ $customers->id }}"
                                                    {{ old('customer_id') == $customers->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        ...
                                        <input type="text"
                                            ...
                                            value=" {{ old('kg') }} " name="kg" placeholder="Berat Pakaian"
                                            autocomplete="off">
                                        @error('kg')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <select
                                            ...
                                            <option value="Pending"
                                                {{ old('status_payment') == 'Pending' ? 'selected' : '' }}>Belum Dibayar
                                            </option>
                                            <option value="Success"
                                                {{ old('status_payment') == 'Success' ? 'selected' : '' }}>Sudah Dibayar
                                            </option>
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        ...
                                        <select
                                            ...
                                            <option value="Tunai"
                                                {{ old('jenis_pembayaran' == 'Tunai' ? 'selected' : '') }}>Tunai</option>
                                            <option value="Transfer"
                                                {{ old('jenis_pembayaran' == 'Transfer' ? 'selected' : '') }}>Transfer
                                            </option>
                                        </select>

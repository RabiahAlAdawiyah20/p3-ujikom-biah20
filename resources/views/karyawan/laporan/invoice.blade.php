...
@section('title', 'Kasir - Laporan Pelanggan')
@section('header', 'Laporan Pelanggan')
@section('content')
    <div class="col-md-12">
        <div class="card card-body printableArea">
            <h3><b>Laporan</b> <span class="pull-right">{{ $data->invoice }}</span></h3>
            <hr>
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-left">
                        <address>
                            ...
                            <p class="text-muted m-l-5"> Diterima Oleh <span style="margin-left:20px"> </span>:
                                {{ $data->user->name }}
                ...
                <div class="col-md-12">
                    ...
                    <div class="text-right">
                        <a href="{{ url('pelayanan') }}" class="btn btn-outline btn-danger" style="color:white">Kembali</a>

    ...
    <div class="row">
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                ...
                <div class="card-body"> <small class="text-muted">Alamat Email</small>
                    <h6>{{ Auth::user()->email }}</h6> <small class="text-muted p-t-30 db">No Whatsapp</small>
                    <h6>+{{ Auth::user()->no_telp }}</h6> <small class="text-muted p-t-30 db">Alamat</small>
                    <h6>{{ Auth::user()->alamat }}</h6>
                    <small class="text-muted p-t-30 db">Sosial Media</small>

                    <br>
                    <button class="btn btn-circle btn-secondary"><a
                            href="https://www.instagram.com/feri.feri.feri.feri.feri/" style="color: white"><i
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                ...
                <div class="card-body">
                    <form action=" {{ url('profile-karyawan/update', Auth::id()) }}" method="POST"

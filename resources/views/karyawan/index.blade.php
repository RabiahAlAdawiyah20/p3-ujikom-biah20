            ...
            <div class="card card-statistics">
                <div class="card-header">
                    ...
                    <div class="d-flex align-items-center">
                        <p class="card-text font-small-2 mr-25 mb-0">Pembaruan 1 bulan yang lalu</p>
                    </div>
                </div>
                        ...
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                            <div class="media">
                                ...
                                <div class="media-body my-auto">
                                    ...
                                    <p class="card-text font-small-1 mb-0">Pelanggan</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
            ...
            <div class="row match-height">
                ...
                <div class="col-lg-6 col-md-3 col-6">
                    <div class="card">
                        <div class="card-body pb-50">
                            <h4>Hari ini</h4>
                            <h6 class="font-weight-bolder mb-1">{{ $kgToday }} <span
                ...
                <div class="col-lg-6 col-md-3 col-6">
                    <div class="card card-tiny-line-stats">
                        <div class="card-body pb-50">
                            <h4>Kemarin</h4>
                            <h6 class="font-weight-bolder mb-1">{{ $kgTodayOld }} <span
                                    style="font-style: italic; font-size:9px">Kg</span></h6>
                            <span style="font-size:10px">Kilogram</span>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <p class="card-text text-muted font-small-2">
                                        <span> Pendapatan {{ $incomeM >= $incomeMOld ? 'naik' : 'turun' }} </span> <span
                                            class="font-weight-bolder">{{ $persen }}%</span> <span> dari bulan
                                            kemarin.</span>
                                    </p>
                                </div>
                            </div>

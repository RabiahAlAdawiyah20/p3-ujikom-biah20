                    ...
                    <ul class="nav navbar-nav float-right">
                        <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label"
                                href="#" data-toggle="dropdown"><i class="ficon feather icon-bell"></i><span
                                    class="badge badge-pill badge-primary badge-up">{{ count(getNotifikasi(Auth::id())) }}</span></a>
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                <li class="dropdown-menu-header">
                                    <div class="dropdown-header m-0 p-2">
                                        <h3 class="white"></h3><span class="notification-title">Notifikasi</span>
                                    </div>
                                </li>
                                            ...
                                            <div class="media d-flex align-items-start">
                                                <div class="media-body">
                                                    <p class="media-heading"><span
                                                            class="font-weight-bolder">{{ $notifikasis->title }}
                                                            🎉</span></p><small class="notification-text">
                                                        {{ $notifikasis->body }}.</small>
                                                </div>
                                            </div>
                                        </a>
                                    @empty
                                        <div class="media d-flex align-items-start">
                                            <div class="media-body">
                                                <p class="media-heading"><span class="font-weight-bolder">Belum ada
                                                        Notifikasi disini.</span></p>
                                                <small class="notification-text"> Notifikasi akan muncul disini ketika
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                @if (auth::user()->auth == 'Admin')
                                    <a class="dropdown-item" href="{{ url('profile-admin', auth::user()->id) }}"><i
                                            class="feather icon-user"></i>Profil
                                    </a>
                                @elseif(auth::user()->auth == 'Karyawan')
                                    ...
                                    {{-- <a class="dropdown-item" href="{{ url('karyawan-setting') }}"><i
                                            class="feather icon-settings"></i>Pengaturan
                                    </a> --}}
                                @elseif(auth::user()->auth == 'Customer')
                                    <a class="dropdown-item" href=" {{ url('me') }} "><i
                                            class="feather icon-user"></i>Profil
                                    </a>
                                    <a class="dropdown-item" href="{{ Route('customer.setting') }}"><i
                                            class="feather icon-settings"></i>Pengaturan
                                    </a>
                                @endif
            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ url('home') }}">
                        <div class="brand-logo">
                            {{-- <img src="{{ asset('frontend/img/londri.png') }}" width="100px" alt=""> --}}
                            {{-- <img src="{{asset('backend/images/pages/login.png')}}" alt="branding logo"> --}}
                        </div>
                        <h2 class="brand-text mb-0 margin-right=10px">Q-LAUNDRY</h2>
                    </a></li>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @if (auth::user()->auth == 'Admin')
                    <li class="nav-item {{ request()->is('home') ? 'active' : '' }}"><a
                            href="{{ url('home') }}"><i class="feather icon-home"></i><span class="menu-title"
                    ...
                    <li class=" nav-item"><a href="#"><i class="feather icon-users"></i><span
                        ...
                        <ul class="menu-content">
                            <li class="nav-item {{ request()->is('karyawan') ? 'active' : '' }}">
                                <a href="{{ route('karyawan.index') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="View">Kasir</span></a>
                            </li>
                            <li class="nav-item {{ request()->is('customer') ? 'active' : '' }}">
                                <a href="{{ url('customer') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Pelanggan</span></a>
                            </li>
                        </ul>
                    </li>

                    <li class="nav-item {{ request()->is('transaksi') ? 'active' : '' }}">
                        <a href="{{ route('transaksi.index') }}"><i class="feather icon-shopping-cart"></i><span
                    ...
                    <li class=" nav-item"><a href="#"><i class="feather icon-credit-card"></i><span
                        ...
                        <ul class="menu-content">
                            <li class="nav-item {{ request()->is('finance') ? 'active' : '' }}">
                                <a href="{{ route('finance.index') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Pendapatan</span></a>
                            </li>
                            <li class="nav-item {{ request()->is('data-harga') ? 'active' : '' }}">
                                <a href="{{ url('data-harga') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Harga Paket Laundry</span></a>
                            </li>
                        </ul>
                    </li>

                    <li class=" nav-item"><a href="#"><i class="feather icon-settings"></i><span
                                class="menu-title" data-i18n="User">Lainnya</span></a>
                        <ul class="menu-content">
                            <li class="nav-item {{ request()->is('settings') ? 'active' : '' }}">
                                <a href="{{ url('settings') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Pengaturan</span></a>
                            </li>
                        </ul>
                    </li>
                    {{-- End Menu Admin --}}
                ...
                @elseif(auth::user()->auth == 'Karyawan')
                    ...
                    <li class=" nav-item"><a href="#"><i class="feather icon-layers"></i><span
                        ...
                        <ul class="menu-content">
                            ...
                            <li class="nav-item {{ request()->is('customers') ? 'active' : '' }}">
                                <a href="{{ url('customers') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Data Pelanggan</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item"><a href="{{ url('/laporan') }}"><i class="feather icon-file-text"></i><span
                    ...
                    {{-- Menu Owner --}}
                @elseif(auth::user()->auth == 'Owner')
                    <li class="nav-item {{ request()->is('finance-owner') ? 'active' : '' }}"><a
                            href="{{ url('finance-owner') }}"><i class="feather icon-home"></i><span
                                class="menu-title" data-i18n="list">Laporan</span></a>
                    </li>

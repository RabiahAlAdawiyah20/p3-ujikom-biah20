...
Route::get('/tk', 'FrontController@tk');
Route::get('/banner', 'FrontController@banner');
...
Route::middleware('auth')->group(function () {
  ...
  Route::prefix('/')->middleware('role:Admin')->group(function () {
    ...
    Route::post('/karyawan', 'Admin\KaryawanController@store')->name('karyawan.store');
    Route::delete('/karyawan/{id}', 'App\Http\Controllers\Admin\KaryawanController@destroy')->name('karyawan.destroy');
    ...
    Route::get('/customer-add', 'App\Http\Controllers\Admin\CustomerController@create')->name('customer.create');
Route::post('/customer-add', 'App\Http\Controllers\Admin\CustomerController@store')->name('customer.store');
Route::put('/customer/update/{id}', 'App\Http\Controllers\Admin\CustomerController@update')->name('customer.update');
Route::get('edit-data','Admin\CustomerController@dataedit');
  ...
  //owner
  Route::prefix('/')->middleware('role:Owner')->group(function () {

    // Finance
    Route::get('finance-owner','Admin\FinanceController@index')->name('finance.owner.index');
